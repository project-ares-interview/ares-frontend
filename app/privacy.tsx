  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.date}>시행일: 2025년 9월 15일</Text>
        ...
        <Text style={styles.sectionTitle}>2. 수집하는 개인정보 항목 및 수집방법</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>3. 개인정보의 수집 및 이용목적</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>6. 개인정보 제공</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>7. 이용자 및 법정대리인의 권리와 그 행사방법</Text>
        <Text style={styles.paragraph}>
          이용자 및 법정 대리인은 언제든지 등록되어 있는 자신 혹은 당해 만 14세 미만 아동의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다.
        </Text>

        <Text style={styles.sectionTitle}>8. 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</Text>
        <Text style={styles.paragraph}>
          회사는 귀하의 정보를 수시로 저장하고 찾아내는 '쿠키(cookie)' 등을 운용합니다. 쿠키란 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다.
        </Text>

        <Text style={styles.sectionTitle}>9. 개인정보에 관한 민원서비스</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>10. 고지의 의무</Text>
        <Text style={styles.paragraph}>
