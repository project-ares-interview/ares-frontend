  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.contentWrapper}>
        ...
        <View style={styles.borderedContainer}>
          <View style={styles.article}>
            ...
            <Text style={styles.articleBody}>
              {"\n"}➀ Ares-frontend(이하 '회사')는 사용자의 개인정보를 소중하게
              생각하며, '정보통신망 이용촉진 및 정보보호 등에 관한 법률' 등
              개인정보보호 관련 법규를 준수하고 있습니다.{"\n"}➁ 회사는 본
              개인정보 처리방침을 통해 사용자가 제공하는 개인정보가 어떠한
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleBody}>
              {"\n"}➀ 수집 항목: (예: 이름, 이메일 주소, 서비스 이용 기록, 접속
              로그, 쿠키, 접속 IP 정보, AI 모델 학습에 사용된 데이터 등)
              {"\n"}➁ 수집 방법: (예: 홈페이지, 서면양식, 게시판, 이메일, 이벤트
              응모, 배송요청, 전화, 팩스, 생성정보 수집 툴을 통한 수집 등)
            </Text>
          </View>
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleBody}>
              ...
              광고에 활용: 신규 서비스(제품) 개발 및 특화, 이벤트 등 광고성 정보
              전달, 인구통계학적 특성에 따른 서비스 제공 및 광고 게재, 접속 빈도
              파악 또는 회원의 서비스 이용에 대한 통계 {"\n"}➃ AI 서비스 개선 및
              연구 개발: AI 모델의 학습, 성능 평가 및 개선을 위한 데이터로 활용
            </Text>
          </View>
          ...
          <View style={styles.article}>
            ...
            <Text style={styles.articleBody}>
              ...
              당해 만 14세 미만 아동의 개인정보를 조회하거나 수정할 수 있으며
              가입해지를 요청할 수도 있습니다.
            </Text>
          </View>
        ...
        <Text style={styles.footer}>시행일: 2025년 9월 15일</Text>
      </View>
    </ScrollView>
  );
}
